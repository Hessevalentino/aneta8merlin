 ...
 */
#define BABYSTEPPING // ValentinoHesse
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. // ValentinoHesse
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping // ValentinoHesse
...
#define CUSTOM_MENU_MAIN // KosiehBarter
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "Custom Commands" // KosiehBarter
  //#define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "REFRESH Home & Bed Level & Save" // KosiehBarter
  #define MAIN_MENU_ITEM_1_GCODE "M501\nG28\nM420 S1\nG29\nM500" // KosiehBarter
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action // KosiehBarter
#endif
